...
namespace Tweet10.Controllers
{
    public class TweetsController : Controller
    {
        ...
        public TweetsController(DatabaseContext context, UserManager<User> userManager)
        {
            _context = context;
        ...
        public async Task<IActionResult> Create([Bind("Id,Text,createdDateTime")] Tweet tweet)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Text,createdDateTime")] Tweet tweet)
        {
            if (id != tweet.Id)
            {
                return NotFound();
